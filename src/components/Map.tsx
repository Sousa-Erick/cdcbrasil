...
const Map: React.FC = () => {
  ...
  const nodes = [
    { x: 400, y: 300, label: "CDC Brasil", color: "#2970F8", main: true },
    { x: 250, y: 200, label: "Norte", color: "#2970F8" },
    { x: 550, y: 200, label: "Nordeste", color: "#2970F8" },
    { x: 300, y: 400, label: "Centro-Oeste", color: "#2970F8" },
    { x: 500, y: 400, label: "Sudeste", color: "#2970F8" },
    { x: 400, y: 500, label: "Sul", color: "#2970F8" },
    { x: 200, y: 300, label: "Institutos de Pesquisa", color: "#2970F8" },
    { x: 600, y: 300, label: "Universidades", color: "#2970F8" },
    { x: 350, y: 150, label: "Hospitais", color: "#2970F8" },
    { x: 450, y: 150, label: "Laboratórios", color: "#2970F8" },
    { x: 300, y: 550, label: "Sociedades Científicas", color: "#2970F8" },
    { x: 500, y: 550, label: "Organizações Internacionais", color: "#2970F8" },
  ];
      ...
      <div className="container mx-auto">
        ...
        <div className="glass-card rounded-xl p-6 md:p-8 animate-fade-in">
          <div className="aspect-w-16 aspect-h-9 mb-8 bg-white/50 rounded-lg flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 backdrop-blur-sm bg-gradient-to-br from-blue-50/40 to-white/40"></div>
            <div className="w-full h-full relative">
              {/* Animação vetorial de rede */}
              <svg 
                ref={svgRef}
                viewBox="0 0 800 600" 
