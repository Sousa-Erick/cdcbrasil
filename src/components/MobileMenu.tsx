...
const MobileMenu: React.FC<MobileMenuProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Overlay com z-index muito alto para garantir que fique sobre tudo */}
      <div
        className={cn(
        ...
        onClick={onClose}
      >
        {/* Conteúdo do menu com z-index ainda maior */}
        <div 
          className={cn(
            "fixed bottom-0 left-0 right-0 z-[201] bg-white rounded-t-2xl max-h-[85vh] overflow-hidden shadow-xl transition-transform duration-300 ease-in-out transform",
