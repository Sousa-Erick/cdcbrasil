...
const Materials: React.FC = () => {
  ...
  return <section id="materials" ref={sectionRef} className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800">Materiais de referência</h2>
          
          <p className="text-gray-600">Acesse documentos com os detalhes sobre a proposta de criação do Centro Brasileiro de Prevenção e Controle de Doenças.</p>
        </div>
        
        <div className="max-w-3xl mx-auto space-y-4">
          {materials.map((material, index) => <div key={index} className="material-item opacity-0 translate-y-8 transition-all duration-500 bg-white rounded-lg p-5 shadow-md border border-gray-200">
              <div className="flex flex-col md:flex-row items-center md:items-start">
                ...
                <div className="flex-grow text-center md:text-left">
                  ...
                  <a href={material.link} className="inline-flex items-center text-salmon hover:text-salmon-600 transition-colors font-medium">
