...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="pt-20 pb-12 md:pt-28 md:pb-16 min-h-screen flex flex-col justify-center relative bg-gradient-to-br from-blue-light via-white to-salmon-light">
      ...
      <div className="container mx-auto px-4 flex flex-col justify-center items-center text-center h-full z-10">
        <div className={`inline-block mb-6 px-4 py-2 bg-blue-light rounded-full transition-all duration-700 ${
          isVisible ? 'opacity-100 transform-none' : 'opacity-0 -translate-y-4'
        }`}>
          <span className="text-sm text-blue font-medium">Uma proposta inovadora para a saúde pública</span>
        </div>
        ...
        <div className={`flex flex-col sm:flex-row gap-4 mb-12 transition-all duration-700 delay-500 ${
          ...
          <a href="#materials" className="px-6 py-3 bg-salmon text-white rounded-lg hover:bg-salmon-600 transition-colors shadow-md">
            Saiba Mais
          </a>
          <a href="#supporters" className="px-6 py-3 bg-white text-blue rounded-lg hover:bg-blue-light transition-colors border border-blue-light shadow-sm">
            Apoie a Proposta
          </a>
        </div>
        ...
        <button 
          ...
          className={`mt-10 inline-flex flex-col items-center text-gray-400 hover:text-blue transition-all duration-700 delay-700 ${
            isVisible ? 'opacity-100 transform-none' : 'opacity-0 translate-y-4'
          }`}
