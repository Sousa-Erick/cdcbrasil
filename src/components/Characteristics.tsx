...
const Characteristics: React.FC = () => {
  ...
  const backgroundColors = ["bg-blue", "bg-blue-600", "bg-salmon", "bg-blue-700", "bg-salmon-600"];
  return <section id="characteristics" ref={sectionRef} className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800">Características da nova instituição</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {characteristics.map((item, index) => <div key={index} className={`characteristic-card opacity-0 translate-y-8 transition-all duration-500 rounded-lg p-6 text-white shadow-lg ${backgroundColors[index % backgroundColors.length]}`}>
