  ...
  return <section id="definition" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div ref={sectionRef} className="max-w-3xl mx-auto opacity-0 translate-y-8 transition-all duration-700">
          ...
          <p className="text-gray-600 mb-8 text-center">É importante entender claramente o papel do
Centro Brasileiro de Prevenção e Controle de Doenças no sistema de saúde</p>
          ...
          <div className="sm:hidden">
            <div className={activeTab === 'is' ? 'block' : 'hidden'}>
              <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <ul className="space-y-4">
                  {whatIs.map((item, index) => <li key={index} className="flex items-start">
            ...
            <div className={activeTab === 'isNot' ? 'block' : 'hidden'}>
              <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <ul className="space-y-4">
                  {whatIsNot.map((item, index) => <li key={index} className="flex items-start">
