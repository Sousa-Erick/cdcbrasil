...
const Principles: React.FC = () => {
  ...
  return (
    <section id="principles" className="py-16 bg-gray-100">
      <div className="container mx-auto px-4">
        <div 
          ref={sectionRef} 
          className="max-w-3xl mx-auto opacity-0 translate-y-8 transition-all duration-700"
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800 text-center">Princípios e estratégias</h2>
          
          <p className="text-gray-600 mb-8 text-center">
            A atuação do Centro Brasileiro de Prevenção e Controle de Doenças será guiada por princípios claros e estratégias bem definidas
          </p>
            ...
            <div className="space-y-4">
              {principles.map((principle, index) => (
                <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                  <button 
                    className="w-full flex items-center justify-between p-4 text-left bg-gray-100 hover:bg-gray-200 transition-colors" 
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            <h3 className="text-xl font-semibold mb-4 text-blue">Estratégias de cooperação</h3>
